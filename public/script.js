window.onload = function() {
	document.getElementById("weatherSubmit").addEventListener("click", async function(event) {
		...
		const url = "https://api.openweathermap.org/data/2.5/weather?q=" + value + ",US&units=imperial" + "&APPID=0a16ffe08907a6a070eb9f39d251fd36";
		try {
		...
		const url2 = "https://api.openweathermap.org/data/2.5/forecast?q=" + value + ", US&units=imperial" + "&APPID=0a16ffe08907a6a070eb9f39d251fd36";
		/*
